    ...
    <div className="section-padding pt-24 sm:pt-28">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 mobile-shell mx-auto text-center">
          <SectionTitle label="Nossa História" title={`Sobre a ${settings?.site_title || "Paradise Beach"}`} subtitle="Mais de uma década conectando pessoas aos seus sonhos à beira-mar." light />
        </div>
      </section>
