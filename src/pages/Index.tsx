...
const heroSlides = [
  { src: slideBg1, alt: "Praia paradisÃ­aca com mirante de madeira e mar calmo" },
  { src: slideBg2, alt: "Farol histÃ³rico Ã  beira-mar com ondas quebrando nas pedras" },
  { src: slideBg3, alt: "Orla urbana ensolarada com praia e vista panorÃ¢mica da cidade" },
];

const benefits = [
  { icon: Gem, title: "Exclusividade", desc: "ImÃ³veis selecionados e curados para os mais exigentes." },
  { icon: Shield, title: "SeguranÃ§a", desc: "TransaÃ§Ãµes seguras com assessoria jurÃ­dica completa." },
  { icon: TrendingUp, title: "Rentabilidade", desc: "Alto potencial de valorizaÃ§Ã£o em localizaÃ§Ãµes premium." },
  { icon: MapPin, title: "LocalizaÃ§Ã£o", desc: "As praias mais paradisÃ­acas do litoral brasileiro." },
];

const testimonials = [
  { name: "Marina Oliveira", role: "EmpresÃ¡ria", text: "A Paradise Beach transformou meu sonho em realidade. O atendimento foi impecÃ¡vel do inÃ­cio ao fim.", rating: 5 },
  { name: "Carlos Mendes", role: "Investidor", text: "Profissionalismo e exclusividade. Encontraram a villa perfeita em Trancoso para minha famÃ­lia.", rating: 5 },
  { name: "Fernanda Costa", role: "Arquiteta", text: "Uma curadoria excepcional de propriedades. Cada imÃ³vel Ã© uma obra de arte Ã  beira-mar.", rating: 5 },
];
...
export default function Index() {
  ...
  return (
    <>
      <Helmet>
        <title>Paradise Beach - ImÃ³veis de Luxo Ã  Beira-Mar | Venda e Aluguel</title>
        <meta name="description" content="Encontre imÃ³veis de luxo Ã  beira-mar no Paradise Beach. Villas, casas e apartamentos premium para venda e aluguel nas melhores praias do Brasil." />
        <meta name="keywords" content="imÃ³veis beira-mar, villas luxo, casas praia, aluguel temporada, venda imÃ³veis litoral" />
        <meta property="og:title" content="Paradise Beach - ImÃ³veis de Luxo Ã  Beira-Mar" />
        <meta property="og:description" content="Viva o paraÃ­so: imÃ³veis premium Ã  beira-mar para venda e aluguel." />
      ...
      {/* Hero â€“ full-screen with sliding backgrounds */}
      <section className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden">
        ...
        <div className="mobile-shell relative z-10 mx-auto text-center" data-reveal>
          <motion.div initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }}>
            <span className="mb-3 block text-xs font-semibold uppercase tracking-[0.3em] text-gold sm:text-sm">ImobiliÃ¡ria de Luxo</span>
            <h1 className="mb-5 text-4xl font-bold leading-tight text-primary-foreground sm:text-5xl md:text-6xl lg:text-7xl">
              Seu ParaÃ­so<br />Ã  Beira-Mar
            </h1>
            <p className="mx-auto mb-8 max-w-2xl text-base font-light text-primary-foreground/80 sm:text-lg md:text-xl">
              Descubra propriedades exclusivas nas praias mais deslumbrantes do Brasil. Viva o estilo de vida que vocÃª sempre sonhou.
            </p>
      ...
      <section className="bg-background py-16 sm:py-20 md:py-24">
        <div className="mobile-shell mx-auto">
          <div data-reveal>
            <SectionTitle label="ExcelÃªncia" title="Por que Paradise Beach?" subtitle="Mais de uma dÃ©cada de expertise em imÃ³veis de alto padrÃ£o no litoral brasileiro." />
          </div>
      ...
      <section className="bg-sand py-16 sm:py-20 md:py-24">
        <div className="mobile-shell mx-auto">
          <div data-reveal>
            <SectionTitle label="PortfÃ³lio" title="ImÃ³veis em Destaque" subtitle="Propriedades excepcionais selecionadas para vocÃª." />
          </div>
          ...
          <div className="mt-10 text-center" data-reveal>
            <Link to="/venda" className="button-pop inline-flex items-center gap-2 rounded-full bg-primary px-8 py-4 font-semibold text-primary-foreground hover:shadow-luxury">
              Ver Todos os ImÃ³veis <ArrowRight size={18} />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="bg-background py-16 sm:py-20 md:py-24">
        <div className="mobile-shell mx-auto">
          <div data-reveal>
            <SectionTitle label="Depoimentos" title="O Que Nossos Clientes Dizem" subtitle="A satisfaÃ§Ã£o dos nossos clientes Ã© o nosso maior patrimÃ´nio." />
          </div>
      ...
      <section className="relative overflow-hidden py-16 sm:py-20 md:py-24">
        <img src={sunsetImg} alt="PÃ´r do sol na praia" className="absolute inset-0 h-full w-full object-cover" loading="lazy" width={1920} height={800} data-parallax />
        <div className="absolute inset-0 bg-foreground/70" />
        <div className="mobile-shell relative z-10 mx-auto text-center" data-reveal>
          <SectionTitle label="Newsletter" title="Receba Novidades Exclusivas" subtitle="Cadastre-se e seja o primeiro a conhecer nossos lanÃ§amentos e oportunidades Ãºnicas." light />
      ...
      <section className="bg-background py-16 sm:py-20 md:py-24">
        <div className="mobile-shell mx-auto text-center" data-reveal>
          <h2 className="mb-6 text-3xl font-bold text-foreground sm:text-4xl md:text-5xl">
            Pronto para Encontrar<br />seu ParaÃ­so?
          </h2>
          <p className="mx-auto mb-10 max-w-xl text-base text-muted-foreground sm:text-lg">
            Nossa equipe de especialistas estÃ¡ pronta para ajudÃ¡-lo a encontrar a propriedade dos seus sonhos.
          </p>
